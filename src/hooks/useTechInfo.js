const useTechInfo = ({ name, rocket, engine, isEngine }) => {
    ...
    const secondRow = {
        title: isEngine ? 'PROPPELANT1' : 'DIAMETER',
        value: isEngine ? engine.proppelant_1 : rocket.diameter.meters + ' m/ ' + rocket.diameter.feet + ' /ft',
    };
    const thirdRow = {
        title: isEngine ? 'PROPPELANT2' : 'STAGES',
        value: isEngine ? engine.proppelant_1 : rocket.stages,
    };
    const fourthRow = {
